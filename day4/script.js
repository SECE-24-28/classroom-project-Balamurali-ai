...
// let b = 20;
// const x = 30.5;
// console.log(a,b,x);//don't use var unless absoluetely necessary because it can be redeclared and reassigned and it can be use even before declaration
// console.log(typeof b);
// const a = [12,"13",14,true,null,undefined,{name:"john"},[1,2,3]];
// a.push(15,16);
// a.pop();
 person = {
   name:"john",
 ...
 /*a.unshift(5);
a.splice(1,3);
 a.splice(2,2,"hello world","this is the use of splice");
 a.splice(-1,2);
console.log("after splice negative",a);*/
x = 5;
const arr = [1,2,3,4,5];
/* console.log("Before Map function: ",arr);
 const newarr =arr.map((num=>num*2));
const newarr = arr.filter(num => num % 2 == 1);
const courses = ["MongoDB","Expressjs","postgres","react"];
const newCourses = courses.filter(course => course != "postgres");
...
return sumArray;}
console.log("Sum of arr:", sumArray(arr));
console.log("Sum of merge:", sumArray(merge));
/*
